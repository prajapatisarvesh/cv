...
\begin{enumerate}[leftmargin=0.5cm]
  \item A. Trivedi, \textbf{S. Prajapati}, M. Zolotas, M. Everett, T. Pad{\i}r, ``Chance-Constrained Convex MPC for Robust Quadruped Locomotion Under Parametric and Additive Uncertainties," 2025, IEEE Robotics and Automation Letters (RA-L).
\end{enumerate}
% \vspace{-1mm}
...
%--copy and paste this region  if you need more--
\begin{enumerate}[leftmargin=0.5cm]
    \item \textbf{S. Prajapati}, A. Trivedi, N. Hanson, B. Maxwell, T. Pad{\i}r, ``Spectral Signature Mapping from RGB Imagery for Terrain-Aware Navigation,'' IEEE Robotic Computing and Communication (IRC), Naples, Italy, 2025.
